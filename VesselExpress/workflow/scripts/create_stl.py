...
def get_mesh(volume, pixelDims=(2.0, 1.015625, 1.015625)):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Creates a stl file from a 3D binary image in tif format"
    )
    ...
    parser.add_argument(
        "-dilation", type=bool, default=False, help="set to True to do binary dilation"
    )
