...
def saveSegmentDictAsCSV(
    dictionary, path, measurementTitle, measurement, unit="", category="Segment"
):
    """
...
def saveBranchPtDictAsCSV(
    dictionary, path, measurementTitle, unit="", category="Branch"
):
    """
    Save a dictionary with measurements as csv file
